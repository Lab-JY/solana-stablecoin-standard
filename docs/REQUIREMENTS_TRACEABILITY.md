...
| BR-09 | Backend services (mint/burn, indexer, compliance, webhook) | Done | `services/mint-burn`, `services/indexer`, `services/compliance`, `services/webhook`, `docs/deployment-artifacts/20260301-170306-docker-compose-integration/integration-test-report.md` |
